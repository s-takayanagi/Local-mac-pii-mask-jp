...
>
> **動作確認済みモデル（2026-04-19）**: `google/gemma-4-e4b`（**推奨**）/ `qwen/qwen3-1.7b` / `LFM2-350M-PII-Extract-JP` で手動テスト済み。

### 3.2 採用コンポーネントのライセンス確認済み一覧

| コンポーネント | ライセンス | 商用利用 | 備考 |
|---|---|---|---|
| **Gemma-4 E4B** (Masker/Reviewer) | Gemma Terms of Use | ✅ 商用利用可 | **推奨モデル**・動作確認済み |
